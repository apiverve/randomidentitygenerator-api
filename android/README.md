# Random Identity Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:randomidentitygenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.randomidentitygenerator.RandomIdentityGeneratorAPIClient;
import com.apiverve.randomidentitygenerator.APIResponse;
import com.apiverve.randomidentitygenerator.APIException;

// Initialize the client
RandomIdentityGeneratorAPIClient client = new RandomIdentityGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randomidentitygenerator](https://docs.apiverve.com/ref/randomidentitygenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/randomidentitygenerator](https://docs.apiverve.com/ref/randomidentitygenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randomidentitygenerator-api/issues)
