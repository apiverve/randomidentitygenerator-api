...
// Request contains the parameters for the Random Identity Generator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Random Identity Generator API.
...
// CompanyData represents the company object.
